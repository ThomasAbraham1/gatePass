...
// Assuming you have a session variable storing the logged-in student's registration number

$loginreg = $_SESSION['student'];

//===================================================================================================
$query = "SELECT * FROM `perpermissions_details` WHERE rollnumber = '$loginreg' ORDER BY `sno` DESC";
