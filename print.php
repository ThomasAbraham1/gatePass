...
$query = "SELECT * FROM `permission_details` WHERE `permissiondetailsid` = ?";
...
try {
    // Specify the printer name (you need to change this to match your printer)
    $printerName = 'TM-T81';
    ...
    // Load and print the logo (if needed)
    $logoPath = './assets/images/gracepng.png';
    ...
    $printer->text("Out Pass ID: " . $permission['permissiondetailsid'] . "\n");
    $printer->text("Roll Number: " . $permission['rollnumber'] . "\n");
    $printer->text("Permission Type: " . $permission['permissiontype'] . "\n");
