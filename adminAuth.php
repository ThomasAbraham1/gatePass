        ...
        <section class="login-content">
            <div class="row m-0 align-items-center bg-white vh-100">
                <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
                    <img src="/gatePass/assets/images/auth/02.png" class="img-fluid gradient-main animated-scaleX" alt="images">
                </div>
                    ...
                    <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                        <div class="card-body">
                            <a href="/gatePass/dashboard/index.html" class="navbar-brand d-flex align-items-center mb-3">
                                ...
                                <h4 class="logo-title ms-3">Gate Pass System</h4>
                            </a>
                            <h2 class="mb-2">Stop right there!</h2>
                            <p>Enter the secret code to move to the protected registration page.</p>
                            <form>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="floating-label form-group">
                                            <label for="secretCode" class="form-label">Secret Code</label>
                                            <input type="text" class="form-control" id="secretCode" aria-describedby="text" placeholder=" ">
                                        </div>
                                    </div>
                                </div>
                                <button id="registrationSecretCodeSubmitBtn" type="submit" class="btn btn-primary">Submit</button>
                            </form>
...
<script>
    $('#registrationSecretCodeSubmitBtn').click(function(e) {
        e.preventDefault();
        var flag = 0;
        ...
        var secretKeyCompareResult = compareSecretCode();
        console.log(flag);
        if (!flag) {
            $("#Result").html(`<div class="alert alert-danger fade show" role="alert">${secretKeyCompareResult}</div>`);
            setTimeout(function() {
                $("#Result").html('');
