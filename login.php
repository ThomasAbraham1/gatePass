                        ...
                        <div class="card-body">
                           <a href="dashboard/index.html" class="navbar-brand d-flex align-items-center mb-3">
                              ...
                              <div class="logo-main">
                                 ...
                                 <svg class="text-primary icon-30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
    <!-- Thunderbolt shape -->
    <path d="M15 1l-3.5 13h3L11 29l14-20h-4l3.5-13z" fill="currentColor"/>
</svg>
                                 ...
                                 <svg class="text-primary icon-30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
    <!-- Thunderbolt shape -->
    <path d="M15 1l-3.5 13h3L11 29l14-20h-4z" fill="currentColor"/>
</svg>
            ...
            <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
               <img src="/gatePass/assets/images/auth/outpassrecep.jpeg" class="img-fluid gradient-main animated-scaleX" alt="images">
            </div>
         </div>
      </section>
   </div>
